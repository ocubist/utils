...
exports.asyncDetectANSISupport = asyncDetectANSISupport;
...
function asyncDetectANSISupport() {
    return __awaiter(this, void 0, void 0, function () {
        var supportsColorModule, userAgent;
        return __generator(this, function (_a) {
            ...
            try {
                ...
                if ((0, isDevelopment_1.isDevelopment)()) {
                    console.warn("Failed to dynamically import supports-color. Proceeding with other checks...");
                }
            ...
            if (process.env.FORCE_ANSI_COLOR) {
                return [2 /*return*/, process.env.FORCE_ANSI_COLOR !== "0"];
            }
...
//# sourceMappingURL=asyncDetectANSISupport.js.map