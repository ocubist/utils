...
exports.asyncParse = exports.AsyncParseFailedError = void 0;
...
var _a = (0, useErrorAlchemy_1.useErrorAlchemy)("ErrorAlchemy", "asyncParse-function"), craftMysticError = _a.craftMysticError, craftErrorTransmuter = _a.craftErrorTransmuter;
exports.AsyncParseFailedError = craftMysticError({
...
var parseFailedTransmuter = craftErrorTransmuter(function (err) { return err instanceof zod_1.ZodError; }, function (err) {
    ...
    return new exports.AsyncParseFailedError({
 ...
 */
var asyncParse = function (value, schema) { return __awaiter(void 0, void 0, void 0, function () {
    var err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, schema.parse(value)];
            case 1: return [2 /*return*/, _a.sent()];
            case 2: return [2 /*return*/, value];
            case 3: return [3 /*break*/, 5];
            case 4:
                err_1 = _a.sent();
                throw parseFailedTransmuter.execute(err_1);
            case 5: return [2 /*return*/];
        }
    });
}); };
exports.asyncParse = asyncParse;
//# sourceMappingURL=asyncParse.js.map